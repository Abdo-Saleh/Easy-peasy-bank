...
public class TransactionsHistoryCustomerGui {

	DefaultTableModel model;
	Customer customer;

	TransactionsHistoryCustomerGui(Customer customer) {
		...
		String headers[] = { "ID", "from", "to", "date", "status", "transactionType" };
	...
	public void initTable() {
		for (int i = 0; i < Database.getCustomerTransactions(customer).size(); i++)
